...
This document describes the protocol extensions for all additional functionality build into the LUA protocol. This doesn't include any of the LUA protocol, which has been left intact in the LUA project. For more information about the core protocol, please see https://en.lua.it/w/index.php?title#Protocol_documentation&action#edit
...
LUA Outpoint https://lua.org/en/glossary/outpoint
...
LUA Input https://lua.org/en/glossary/input
...
LUA Output https://lua.org/en/glossary/output
...
LUA Public Key https://lua.org/en/glossary/public-key
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin | [CTxIn](#ctxin) | The unspent output which is holding 1000 LUA
| # | addr | [CService](#cservice) | IPv4 address of the masternode
| 33-65 | pubKeyCollateralAddress | [CPubKey](#cpubkey) | CPubKey of the main 1000 LUA unspent output
...
| 10004 | 5 | INSTANTSEND_MAX_VALUE | Controls the max value for an InstantSend transaction (currently 2000 lua)
| 10007 | 8 | MASTERNODE_PAYMENT_ENFORCEMENT | Requires masternodes to be paid by miners when blocks are processed
| 10008 | 9 | SUPERBLOCKS_ENABLED | Superblocks are enabled (the 10% comes to fund the lua treasury)
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin1 | [CTxIn](#ctxin) | The unspent output which is holding 1000 LUA for masternode 1
| 41 | vin2 | [CTxIn](#ctxin) | The unspent output which is holding 1000 LUA for masternode 2
