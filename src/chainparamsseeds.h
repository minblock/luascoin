#ifndef LUASCOIN_CHAINPARAMSSEEDS_H
#define LUASCOIN_CHAINPARAMSSEEDS_H
/**
 * List of fixed seed nodes for the luascoin network
...
#endif // LUASCOIN_CHAINPARAMSSEEDS_H
