...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("LUASCOIN Core luascoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  luascoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded luascoin transaction") + "\n" +
              "  luascoin-tx [options] -create [commands]   " + _("Create hex-encoded luascoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded luascoin transaction
