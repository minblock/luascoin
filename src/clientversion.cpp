 ...
 * for both luad and lua-qt, to make it harder for attackers to
 * target servers or GUI users specifically.
 */
const std::string CLIENT_NAME("LUA Core");
...
/** 
 * Format the subversion field according to BIP 14 spec (https://github.com/lua/bips/blob/master/bip-0014.mediawiki) 
 */
