...
#ifndef LUASCOIN_WALLET_WALLET_H
#define LUASCOIN_WALLET_WALLET_H
...
public:
    ...
    /// Get 1000LUASCOIN output and keys which can be used for the Masternode
...
#endif // LUASCOIN_WALLET_WALLET_H
