...
#include "config/lua-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatLUAURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + LUAUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatLUAURI(info));
}
