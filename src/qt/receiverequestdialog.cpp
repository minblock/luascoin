...
#include "config/luascoin-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatLUASCOINURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + LUASCOINUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatLUASCOINURI(info));
}
