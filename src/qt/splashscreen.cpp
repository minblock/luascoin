    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextLUA   = QChar(0xA9)+QString(" 2017-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("Developed by Devilking6105 & IamLegion"));
    ...
    pixPaint.drawText(paddingLeft,paddingTop+titleCopyrightVSpace,copyrightTextLUA);
