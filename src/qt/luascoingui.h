...
#ifndef LUASCOIN_QT_LUASCOINGUI_H
#define LUASCOIN_QT_LUASCOINGUI_H
...
/**
  LUASCOIN GUI main class. This class represents the main window of the LUASCOIN UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class LUASCOINGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit LUASCOINGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~LUASCOINGUI();
...
private Q_SLOTS:
    ...
    /** Open external (default) editor with luascoin.conf */
    void showConfEditor();
...
#endif // LUASCOIN_QT_LUASCOINGUI_H
