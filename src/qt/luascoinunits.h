...
#ifndef LUASCOIN_QT_LUASCOINUNITS_H
#define LUASCOIN_QT_LUASCOINUNITS_H
...
/** LUASCOIN unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class LUASCOINUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit LUASCOINUnits(QObject *parent);

    /** LUASCOIN units.
      @note Source: https://en.luascoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        LUASCOIN,
...
typedef LUASCOINUnits::Unit LUASCOINUnit;

#endif // LUASCOIN_QT_LUASCOINUNITS_H
