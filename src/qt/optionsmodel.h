...
#ifndef LUASCOIN_QT_OPTIONSMODEL_H
#define LUASCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for LUASCOIN client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // LUASCOINUnits::Unit
...
#endif // LUASCOIN_QT_OPTIONSMODEL_H
