...
#ifndef LUA_QT_LUAGUI_H
#define LUA_QT_LUAGUI_H
...
/**
  LUA GUI main class. This class represents the main window of the LUA UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class LUAGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit LUAGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~LUAGUI();
...
private Q_SLOTS:
    ...
    /** Open external (default) editor with lua.conf */
    void showConfEditor();
