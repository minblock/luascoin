...
#ifndef LUA_QT_LUAUNITS_H
#define LUA_QT_LUAUNITS_H
...
/** LUA unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class LUAUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit LUAUnits(QObject *parent);

    /** LUA units.
      @note Source: https://en.lua.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        LUA,
...
typedef LUAUnits::Unit LUAUnit;

#endif // LUA_QT_LUAUNITS_H
