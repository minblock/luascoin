...
static const CLUASCOINAddress addr1 ("Xywgfc872nn5CKtpATCoAjZCc4v96pJczy");
static const CLUASCOINAddress addr2 ("XpmouUj9KKJ99ZuU331ZS1KqsboeFnLGgK");
static const CLUASCOINAddress addr1C("XxV9h4Xmv6Pup8tVAQmH97K6grzvDwMG9F");
static const CLUASCOINAddress addr2C("Xn7ZrYdExuk79Dm7CJCw7sfUWi2qWJSbRy");
...
void dumpKeyInfo(uint256 privkey)
{
    ...
    for (int nCompressed=0; nCompressed<2; nCompressed++)
    {
        ...
        printf("    * address (base58): %s\n", CLUASCOINAddress(vchPubKey).ToString().c_str());
    }
}
#endif
...
{
    CLUASCOINSecret bsecret1, bsecret2, bsecret1C, bsecret2C, baddress1;
