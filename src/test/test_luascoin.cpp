...
#define BOOST_TEST_MODULE LUASCOIN Test Suite

#include "test_luascoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_luascoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
