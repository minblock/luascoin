...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CLUAAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CLUAAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey(0, false);
        demoAddress = CLUAAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CLUAAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CLUAAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CLUAAddress(arr[0].get_str()).Get() == demoAddress.Get());
