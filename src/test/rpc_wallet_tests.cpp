...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CLUASCOINAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CLUASCOINAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey(0, false);
        demoAddress = CLUASCOINAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CLUASCOINAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CLUASCOINAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CLUASCOINAddress(arr[0].get_str()).Get() == demoAddress.Get());
