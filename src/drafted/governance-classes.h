 ...
 *
 *   // network
 *   CLUASCOINNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.luascoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CLUASCOINNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CLUASCOINNetwork(UniValue objIn)
    {
...
// // can be under: LUASCOINNetwork
// //   -- signature requirements : Key1(User)
// class CLUASCOINNetworkVariable : public CGovernanceObject
// {
// private:
