 ...
 *
 *   // network
 *   CLUANetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.lua.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CLUANetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: LUANetwork
// //   -- signature requirements : Key1(User)
// class CLUANetworkVariable : public CGovernanceObject
// {
// private:
