...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1581341820, 1255673, 0x1e0ffff0, 1, 50 * COIN);
...
/*   
  ...
  */   
        assert(consensus.hashGenesisBlock == uint256S("00000caaed661f2babbbeb2cd41b96a346b111d71d0f7d063f686f276d670fad"));
