/* src/config/luascoin-config.h.  Generated from luascoin-config.h.in by configure.  */
/* src/config/luascoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef LUASCOIN_CONFIG_H

#define LUASCOIN_CONFIG_H
...
#define PACKAGE_BUGREPORT "https://github.com/luascoincrypto/luascoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "LUASCOIN Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "LUASCOIN Core 2.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "luascoincore"
