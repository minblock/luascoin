...
unlocked to sign the LUASCOIN-Qt.app bundle.
...
allowing somebody to distribute a LUASCOIN-Qt.app or luascoin-qt-setup.exe with a valid
...
that the luascoin-qt.exe file inside the installer had not been tampered with.
