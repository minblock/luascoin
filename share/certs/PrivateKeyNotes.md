...
unlocked to sign the LUA-Qt.app bundle.
...
allowing somebody to distribute a LUA-Qt.app or lua-qt-setup.exe with a valid
...
that the lua-qt.exe file inside the installer had not been tampered with.
