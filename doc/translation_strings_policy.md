...
This document provides guidelines for internationalization of the LUASCOIN Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `luascoin_en.ts` remains unchanged.
