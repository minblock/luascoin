...
This document provides guidelines for internationalization of the LUA Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `lua_en.ts` remains unchanged.
