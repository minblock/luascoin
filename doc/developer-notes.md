...
LUA Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- LUAMiner : Generates coins (if wallet is enabled).
...
However, in open source software such as LUA Core, where everyone uses
...
pay attention to for reviewers of LUA Core code.
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: LUA Core uses tinyformat, which is type safe. Leave them out to avoid confusion
