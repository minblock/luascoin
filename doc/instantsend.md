...
This mechanism has been integrated into Bitcore-Node-LUASCOIN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/luascoincrypto/insight-api-luascoin#web-socket-api](https://github.com/luascoincrypto/insight-api-luascoin#web-socket-api)
* API: [https://github.com/luascoincrypto/insight-api-luascoin#instantsend-transactions](https://github.com/luascoincrypto/insight-api-luascoin#instantsend-transactions)
...
By default, the LUASCOIN Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the LUASCOIN Core daemon:
