...
This mechanism has been integrated into Bitcore-Node-LUA which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/minblock/insight-api-lua#web-socket-api](https://github.com/minblock/insight-api-lua#web-socket-api)
* API: [https://github.com/minblock/insight-api-lua#instantsend-transactions](https://github.com/minblock/insight-api-lua#instantsend-transactions)
...
By default, the LUA Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the LUA Core daemon:
